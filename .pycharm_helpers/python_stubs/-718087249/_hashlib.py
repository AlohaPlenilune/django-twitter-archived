...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha224', 'md4', 'shake128', 'shake256', 'whirlpool', 'blake2s256', 'sha3-256', 'sha256', 'sha3-224', 'sha1', 'sha3-384', 'md5', 'sha512', 'sha512-224', 'ripemd160', 'md5-sha1', 'sha384', 'sha512-256', 'sm3', 'blake2b512', 'sha3-512'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb91be37c50>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb91be37c50>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
